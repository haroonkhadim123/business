...
export default function AddBrand() {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-gray-800 shadow-2xl md:mt-14 p-4 md:p-10 rounded-lg max-w-3xl mx-auto"
    >
      ...
      <form onSubmit={handlesubmit} className="space-y-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative">
            <Tag size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-400" />
            <input
              type="text"
        ...
        {/* Website URL */}
        <div className="flex flex-col gap-2">
          <label className="text-sm font-medium text-gray-600 dark:text-gray-300 mt-2">Website URL</label>
          <div className="relative">
            <Globe size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-400" />
            <input
              type="url"
        ...
        {/* Description */}
        <div className="flex flex-col gap-2">
          <label className="text-sm font-medium text-gray-600 dark:text-gray-300 mt-2">Description</label>
          <div className="relative">
