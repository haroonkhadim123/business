...
useEffect(() => {
  ...
  viewport={{ once: true }}
  className="absolute top-10 -left-10 bg-blue-900 text-white p-8 rounded-2xl shadow-xl"
>
...
<motion.div
  ...
  className="absolute -bottom-12 right-10 bg-white p-3 rounded-2xl shadow-2xl"
>
  <Image
    src="/about2.jpg"
  ...
  />
        ...
        >
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mt-4">
            ...
            <span className="text-gray-900"> Corporate Growth</span>
          </h2>

          <p className="text-gray-600 mt-6 leading-relaxed">
            We are a trusted corporate consultancy firm dedicated to helping
            businesses grow, innovate, and lead in competitive markets.
            Our expert team provides strategic planning, operational
            excellence, and sustainable growth solutions.
          </p>
          ...
          >
            <div className="bg-gray-900 p-5 rounded-xl text-white text-lg shadow-lg">
              <Phone/>
            </div>
          ...
          {/* CEO Signature */}
          <p className="mt-12 text-2xl font-serif italic text-gray-800">
            Qandeel Faryad
          </p>
